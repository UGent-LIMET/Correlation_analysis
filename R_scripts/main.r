...
## options
PATH_USER <- '~/Google Drive/Mijn Drive/Werk-UGent/2024-2-metabolomics/GitHub/Correlation_analysis/' # example path user
...
if (CODE_RUN_MODE == CODE_AUTORUN){
  ...
  name_project = "FAME_Corr_Clin" #commandArgs(trailingOnly=TRUE) #name is given in "Rscript main.r projectname" as argument
