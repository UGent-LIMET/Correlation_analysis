...
## Adjustments
#Project name:
EXPERIMENT <- 'FAME_Anthropo_Mental Wellbeing_Tardis_3batches_apart' #structured and short, see READ_ME
...
if(RUN_PART_CORRELATION == RUN_CODE){
  ...
  INPUT_VARIABLES1 <- 'VM1_part_metabolomics2.txt'  #'name.txt' of file.
